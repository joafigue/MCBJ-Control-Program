...
#+BEGIN_SRC python
  ...
  ############################################################
  def execute_ui_cmd(ui_cmd,run_config) :
      switch = {
...
#+BEGIN_SRC python
  ...
  ############################################################
  while True :
      ui_result  = ui_get_gui_result()
      ui_cmd     = ui_result.cmd
      run_config = ui_result.config
      execute_ui_cmd(ui_cmd,run_config)
#+END_SRC
...
*** UI - Program Interface
 ...
 #+BEGIN_SRC python
   ...
   class UI_RESULT:
       ...
       ############################################################
       ## @brief   Updates the config with a new onw
       ############################################################
...
#+BEGIN_SRC python
  ...
  ############################################################
  def run_gui():
      app = QtGui.QApplication(sys.argv) # Create appliaction
      widget = ui_config_widget()        # Instantiate widget
      app.exec_()                        # Execute appliaction
      return widget.ui_result
#+END_SRC


#+BEGIN_SRC python
  class ui_config_widget(QtGui.QWidget):

      def __init__(self):
          super(ui_config_widget, self).__init__()
          self.initUI()
